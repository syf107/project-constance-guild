    ...
    <section className="container bg-amber-500  border-b-4 border-amber-700 pb-15">
      <div className="bg-linear-to-b from-amber-500 from-0% via-amber-300 via-50% to-amber-500 to-100% ">
        <div className="text-center mx-auto w-4/5 text-amber-900">
          ...
          <p className="text-lg text-justify mb-8 indent-15">
          ...
          <Link
            to="/history"
            className="text-xl bg-amber-400 px-5 py-2 border-4 font-semibold border-double border-amber-500 hover:cursor-pointer hover:bg-amber-700 hover:text-amber-400 transition-color duration-200"
          >
            Read More Our Story
          </Link>
        </div>
